...
import (
	...
	"github.com/Fotkurz/braza/internal/services/formatters/c/flawfinder"
	...
	"github.com/Fotkurz/braza/internal/services/formatters/csharp/scs"
	"github.com/Fotkurz/braza/internal/services/formatters/dart/horusecdart"
	"github.com/Fotkurz/braza/internal/services/formatters/elixir/mixaudit"
	"github.com/Fotkurz/braza/internal/services/formatters/elixir/sobelow"
	dependencycheck "github.com/Fotkurz/braza/internal/services/formatters/generic/dependency_check"
	"github.com/Fotkurz/braza/internal/services/formatters/generic/semgrep"
	"github.com/Fotkurz/braza/internal/services/formatters/generic/trivy"
	"github.com/Fotkurz/braza/internal/services/formatters/go/gosec"
	"github.com/Fotkurz/braza/internal/services/formatters/go/nancy"
	"github.com/Fotkurz/braza/internal/services/formatters/hcl/checkov"
	"github.com/Fotkurz/braza/internal/services/formatters/hcl/tfsec"
	...
	"github.com/Fotkurz/braza/internal/services/formatters/javascript/npmaudit"
	"github.com/Fotkurz/braza/internal/services/formatters/javascript/yarnaudit"
	"github.com/Fotkurz/braza/internal/services/formatters/kotlin/horuseckotlin"
	"github.com/Fotkurz/braza/internal/services/formatters/leaks/gitleaks"
	...
	"github.com/Fotkurz/braza/internal/services/formatters/php/phpcs"
	"github.com/Fotkurz/braza/internal/services/formatters/python/bandit"
	"github.com/Fotkurz/braza/internal/services/formatters/python/safety"
	"github.com/Fotkurz/braza/internal/services/formatters/ruby/brakeman"
	"github.com/Fotkurz/braza/internal/services/formatters/ruby/bundler"
	"github.com/Fotkurz/braza/internal/services/formatters/shell/shellcheck"
