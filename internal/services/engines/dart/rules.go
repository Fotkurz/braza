...
func NewUsageLocalDataWithoutCryptography() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			SafeExample:   SampleSafeHSDART1,
			UnsafeExample: SampleVulnerableHSDART1,
		},
		Type: text.AndMatch,
...
func NewNoSendSensitiveInformation() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Info.ToString(),
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSDART2,
			UnsafeExample: SampleVulnerableHSDART2,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewXmlReaderExternalEntityExpansion() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			SafeExample:   SampleSafeHSDART4,
			UnsafeExample: SampleVulnerableHSDART4,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewNoUseConnectionWithoutSSL() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSDART5,
			UnsafeExample: SampleVulnerableHSDART5,
		},
		Type: text.OrMatch,
		Expressions: []*regexp.Regexp{
...
func NewSendSMS() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSDART6,
			UnsafeExample: SampleVulnerableHSDART6,
		},
		Type: text.OrMatch,
		Expressions: []*regexp.Regexp{
...
func NewXSSAttack() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSDART7,
			UnsafeExample: SampleVulnerableHSDART7,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoLogSensitive() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Info.ToString(),
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSDART8,
			UnsafeExample: SampleVulnerableHSDART8,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewWeakHashingFunctionMd5OrSha1() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSDART9,
			UnsafeExample: SampleVulnerableHSDART9,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoUseSelfSignedCertificate() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSDART10,
			UnsafeExample: SampleVulnerableHSDART10,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoUseBiometricsTypeAndroid() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSDART11,
			UnsafeExample: SampleVulnerableHSDART11,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoListClipboardChanges() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Info.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSDART12,
			UnsafeExample: SampleVulnerableHSDART12,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewSQLInjection() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSDART13,
			UnsafeExample: SampleVulnerableHSDART13,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoUseNSTemporaryDirectory() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Info.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSDART14,
			UnsafeExample: SampleVulnerableHSDART14,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoUseCipherMode() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSDART15,
			UnsafeExample: SampleVulnerableHSDART15,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewCorsAllowOriginWildCard() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSDART16,
			UnsafeExample: SampleVulnerableHSDART16,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewUsingShellInterpreterWhenExecutingOSCommand() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSDART17,
			UnsafeExample: SampleVulnerableHSDART17,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
