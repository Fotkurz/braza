	...
	testcases := []*testutil.RuleTestCase{
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-1.test"),
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-2.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-4.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-5.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-7.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-8.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-10.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-11.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-12.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-13.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-14.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-15.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-16.test"),
			Findings: []engine.Finding{
				{
		...
		},
		{
			...
			Filename: filepath.Join(tempDir, "HS-DART-17.test"),
			Findings: []engine.Finding{
				{
