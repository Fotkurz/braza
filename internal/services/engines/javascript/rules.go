...
func NewNoLogSensitiveInformationInConsole() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			SafeExample:   SampleSafeHSJAVASCRIPT1,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT1,
		},
		Type: text.Regular,
...
func NewNoUseEval() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			SafeExample:   SampleSafeHSJAVASCRIPT2,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT2,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoDisableTlsRejectUnauthorized() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Critical.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT3,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT3,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoUseMD5Hashing() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT4,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT4,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoUseSHA1Hashing() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT5,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT5,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoUseWeakRandom() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT6,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT6,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoReadFileUsingDataFromRequest() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT7,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT7,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoCreateReadStreamUsingDataFromRequest() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT8,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT8,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewSQLInjectionUsingParams() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			SafeExample:   SampleSafeHSJAVASCRIPT9,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT9,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewXMLParsersShouldNotBeVulnerableToXXEAttacks() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT10,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT10,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
When receiving message with message event, the sender's identity should be verified using the origin and possibly source properties. For more information checkout the OWASP A2:2017 (https://owasp.org/www-project-top-ten/2017/A2_2017-Broken_Authentication) and (https://developer.mozilla.org/en-US/docs/Web/API/Window/postMessage) advisory.`,
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT11,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT11,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewWeakSSLTLSProtocolsShouldNotBeUsed() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT12,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT12,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
Further, the use of a Web SQL Database poses security concerns, since you only need its name to access such a database. For more information checkout the OWSAP A3:2017 (https://owasp.org/www-project-top-ten/2017/A3_2017-Sensitive_Data_Exposure.html) and A9:2017 (https://owasp.org/www-project-top-ten/2017/A9_2017-Using_Components_with_Known_Vulnerabilities.html) advisory.`,
			Severity:      severities.High.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT13,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT13,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewLocalStorageShouldNotBeUsed() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Info.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT14,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT14,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewDebuggerStatementsShouldNotBeUsed() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT15,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT15,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewAlertStatementsShouldNotBeUsed() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT16,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT16,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewStaticallyServingHiddenFilesIsSecuritySensitive() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT17,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT17,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
This rule highlights intrusive permissions when requested with the future standard (but currently experimental) web browser query API and specific APIs related to the permission. It is highly recommended to customize this rule with the permissions considered as intrusive in the context of the web application. If geolocation is required, always explain to the user why the application needs it and prefer requesting an approximate location when possible. For more information checkout the CWE-250 (https://cwe.mitre.org/data/definitions/250.html) and OWASP A3:2017 (https://owasp.org/www-project-top-ten/2017/A3_2017-Sensitive_Data_Exposure.html) advisory.`,
			Severity:      severities.Info.ToString(),
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT18,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT18,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewHavingAPermissiveCrossOriginResourceSharingPolicy() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT19,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT19,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewReadingTheStandardInput() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT20,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT20,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewUsingCommandLineArguments() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT21,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT21,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewRedirectToUnknownPath() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT22,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT22,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoRenderContentFromRequest() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT23,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT23,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoWriteOnDocumentContentFromRequest() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT24,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT24,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoExposeStackTrace() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT25,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT25,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewInsecureDownload() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT26,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT26,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
...
func NewNoUseRequestMethodUsingDataFromRequestOfUserInput() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT27,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT27,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewNoUseGetMethodUsingDataFromRequestOfUserInput() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT28,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT28,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewCryptographicRsaShouldBeRobust() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Critical.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT29,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT29,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewCryptographicEcShouldBeRobust() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT30,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT30,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewJWTNeedStrongCipherAlgorithms() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Critical.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT31,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT31,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewServerHostnameNotVerified() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT32,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT32,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewServerCertificatesNotVerified() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT33,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT33,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewUntrustedContentShouldNotBeIncluded() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT34,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT34,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewUsingShellInterpreterWhenExecutingOSCommands() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Low.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT36,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT36,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewForwardingClientIPAddress() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT37,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT37,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewAllowingConfidentialInformationToBeLoggedWithSignale() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT38,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT38,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewAllowingBrowsersToPerformDNSPrefetching() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT39,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT39,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewDisablingCertificateTransparencyMonitoring() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT40,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT40,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewDisablingStrictHTTPNoReferrerPolicy() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT41,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT41,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewAllowingBrowsersToSniffMIMETypes() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT42,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT42,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewDisablingContentSecurityPolicyFrameAncestorsDirective() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT43,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT43,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewAllowingMixedContent() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT44,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT44,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewDisablingContentSecurityPolicyFetchDirectives() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT45,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT45,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewCreatingCookiesWithoutTheHttpOnlyFlag() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT46,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT46,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewCreatingCookiesWithoutTheSecureFlag() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT47,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT47,
		},
		Type: text.AndMatch,
		Expressions: []*regexp.Regexp{
...
func NewEncryptionAlgorithmsWeak() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT49,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT49,
		},
		Type: text.OrMatch,
		Expressions: []*regexp.Regexp{
...
func NewFileUploadsShouldBeRestricted() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Medium.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT50,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT50,
		},
		Type: text.OrMatch,
		Expressions: []*regexp.Regexp{
...
func NewAllowingRequestsWithExcessiveContentLengthSecurity() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT51,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT51,
		},
		Type: text.OrMatch,
		Expressions: []*regexp.Regexp{
...
func NewNoDisableSanitizeHtml() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.Low.ToString(),
			Confidence:    confidence.High.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT52,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT52,
		},
		Type: text.OrMatch,
		Expressions: []*regexp.Regexp{
...
func NewSQLInjection() *text.Rule {
	return &text.Rule{
		Metadata: engine.Metadata{
			...
			Severity:      severities.High.ToString(),
			Confidence:    confidence.Medium.ToString(),
			SafeExample:   SampleSafeHSJAVASCRIPT53,
			UnsafeExample: SampleVulnerableHSJAVASCRIPT53,
		},
		Type: text.Regular,
		Expressions: []*regexp.Regexp{
